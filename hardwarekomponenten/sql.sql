...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 18. Okt 2023 um 10:24
...
--
-- RELATIONEN DER TABELLE `tbl_kategorien`:
--   `FIDKategorie`
...
--
-- RELATIONEN DER TABELLE `tbl_konfigurator`:
--   `FIDPC`
...
--
-- RELATIONEN DER TABELLE `tbl_lieferbarkeiten`:
--
...
--
-- RELATIONEN DER TABELLE `tbl_produkte`:
--   `FIDKategorie`
--       `tbl_kategorien` -> `IDKategorie`
--   `FIDLieferbarkeit`
--       `tbl_lieferbarkeiten` -> `IDLieferbarkeit`
--
